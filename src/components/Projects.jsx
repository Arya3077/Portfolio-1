...
const Projects = () => {
  return (
    <section id="Projects" className="bg-primary dark:bg-primary-dark px-4 md:px-10 py-20">
      <div className="max-w-6xl mx-auto flex flex-col gap-12">
        <h2 className="text-4xl md:text-5xl font-mono font-extrabold text-[#10002B] mb-10">
          PROJECTS
        </h2>
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-20 items-center justify-center w-full">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <h3 className="text-xl md:text-2xl font-extrabold text-fuchsia-950 mt-4">
